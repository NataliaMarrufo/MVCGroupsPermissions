...
namespace WebAppTimOne.Migrations
{
    internal sealed class Configuration : DbMigrationsConfiguration<ApplicationDbContext>
    {
        private const string InitialUserName = "SuperAdminPower";
        private const string InitialUserFirstName = "Super";
        private const string InitialUserLastName = "Admin";
        private const string InitialUserEmail = "superAdmin@gmail.com";
        private const string InitialUserPassword = "Password1";

        private const string NormalUserName = "JuanP";
        private const string NormalUserFirstName = "Juan";
        private const string NormalUserLastName = "Perez";
        private const string NormalUserEmail = "juanPerez@test.com";
        private const string NormalUserPassword = "Password1";
        ...
        private void AddUsers()
        {
            ...
            var newVaniallaUser = new ApplicationUser {
              ...
              FirstName = NormalUserFirstName,
              LastName = NormalUserLastName,
              Email = NormalUserEmail
            };

            
            userCreationResult = _idManager.CreateUser(newVaniallaUser, NormalUserPassword);
            if (!userCreationResult.Succeeded) {
              // warn the user that it's seeding went wrong
              throw new DbEntityValidationException("Could not create NormalUser because: " + String.Join(", ", userCreationResult.Errors));
            }
        }
        ...
        private void AddUsersToGroups()
        {
            ...
            user = _db.Users.FirstOrDefault(u => u.UserName == NormalUserName);
